...
const blogPosts = [
	{
		...
		excerpt:
			'Изучите экологически чистые альтернативы традиционному почвенному покрытию для современных свалок.',
		date: '2024-03-15',
		author: 'RSGA Team',
	...
	},
	{
		...
		excerpt:
			'Сравнительный анализ методов восстановления растительности для крупномасштабных проектов.',
		date: '2024-03-10',
		author: 'RSGA Team',
		category: 'Технологии',
	...
	},
	{
		...
		excerpt:
			'Руководство по соблюдению европейских норм в области управления отходами.',
		date: '2024-03-05',
		author: 'RSGA Team',
					...
					<div className='container-3of4'>
						<div className='text-center max-w-3xl mx-auto'>
							...
							<p className='text-xl text-fg-secondary leading-relaxed'>
								Инсайты, новости и экспертные мнения в области
                  ...
                  {category}
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
							{blogPosts.map(post => (
								<Card
									key={post.id}
									className='group cursor-pointer card-premium hover:shadow-lg transition-all duration-300'
								>
					...
					<div className='container-3of4'>
						<div className='text-center max-w-2xl mx-auto'>
							...
							<p className='text-lg text-fg-secondary mb-8'>
								Получайте последние новости и инсайты в области
								экологических решений
							</p>
