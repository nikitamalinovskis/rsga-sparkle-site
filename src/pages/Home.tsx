...
const pageData = {
	...
	services: [
		{
			...
			description:
				'Videi draudzīgs ikdienas augsnes pārklājuma aizstājējs, kas taupa resursus un izmaksas.',
			category: 'Core',
		...
		},
		{
			...
			title: 'Hidrosēja',
			description:
				'Izdevīga metode erozijas kontrolei un veģetācijas atjaunošanai.',
			category: 'Core',
		...
		},
		{
			...
			description:
				'Smaku kontrole un putekļu samazināšana poligonos un industriālajās teritorijās.',
			category: 'Core',
		...
		},
		{
			...
			description:
				'Kvalitatīvas smilts piegāde būvniecībai un rūpniecībai.',
			category: 'Additional',
		...
		},
		{
			...
			title: 'Zemes darbi',
			description:
				'Pilna cikla izrakumi un teritoriju sagatavošanas darbi.',
			category: 'Additional',
		...
		},
		{
			...
			description:
				'Stratēģiskās konsultācijas poligonu plānošanā un ilgtspējīgai izaugsmei.',
			category: 'Additional',
	...
	video_block: {
		...
		description:
			'Šis video demonstrē RSGA pieeju ilgtspējīgai poligonu apsaimniekošanai, izceļot alternatīvos pārklājuma risinājumus, hidrosēšanas tehnoloģijas un industriālo dezodorantu pielietojumu.'
	},
	endorsements: [
		{
			company: 'Getliņi EKO',
			...
			testimonial:
				'Vairāk nekā 10 gadus mūsu uzņēmums no SIA RSGA iegādājas pakalpojumu – alternatīvo dienas pārklājumu poligonā Getliņi EKO. Šajā laikā ir izveidojusies sekmīga sadarbība, nodrošinot ilgtspējīgu un izmaksu efektīvu poligona darbību.',
		...
		},
		{
			...
			role: 'Valdes priekšsēdētājs',
			testimonial:
				'Pateicoties RSGA inovatīvajiem dezodorantu risinājumiem, mēs esam spējuši uzlabot vides komfortu un minimizēt smaku ietekmi uz tuvākajām kopienām.',
			link: 'https://rsga.lv/docs/Vidusdaugavas_SPAAO_en.pdf'
		},
		{
			...
			role: 'Valdes priekšsēdētājs',
			testimonial:
				'Ar RSGA alternatīvo pārklājumu risinājumiem mēs esam samazinājuši izmaksas, vienlaikus saglabājot vides drošības standartus Ķivīšu poligonā.',
