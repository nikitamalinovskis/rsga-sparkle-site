...
const pageData = {
	hero: {
		...
		subtitle:
			'RSGA provides sustainable and cost-efficient services for landfills and construction sites.',
		cta: [
	...
	services: [
		{
			...
			description:
				'Modern replacement for soil cover reducing costs and logistics, EU-compliant.',
			category: 'Core',
		...
		},
		{
			...
			title: 'Hydroseeding',
			description:
				'Fast, cost-effective erosion control and vegetation establishment for slopes and sites.',
			category: 'Core',
		...
		},
		{
			...
			description:
				'Odor mitigation and dust suppression for landfills, roads, and industrial areas.',
			category: 'Core',
		...
		},
		{
			...
			title: 'Sale of sand',
			description:
				'Reliable supply for construction and industrial needs.',
			category: 'Additional',
		...
		},
		{
			...
			title: 'Earthworks',
			description:
				'Excavation, leveling, site prep for infrastructure and construction.',
			category: 'Additional',
		...
		},
		{
			...
			description:
				'Consulting for sustainable landfill management, compliance, and growth.',
			category: 'Additional',
	...
	video_block: {
		...
		description:
			"This video showcases RSGA's approach to sustainable landfill management, highlighting alternative cover solutions, hydroseeding technology, and industrial deodorant applications."
	},
	endorsements: [
		{
			company: 'Getliņi EKO',
			...
			testimonial:
				'For more than 10 years, our company has been buying from SIA RSGA the service – Alternative Daily Coverage at the landfill Getliņi EKO. During this period, a successful cooperation has developed, ensuring sustainable and cost-efficient landfill operations.',
		...
		},
		{
			...
			role: 'Chair of the Board',
			testimonial:
				"Thanks to RSGA's innovative deodorant solutions, we have been able to improve environmental comfort and minimize odor impact for nearby communities.",
		...
		},
		{
			...
			role: 'Chair of the Board',
			testimonial:
				"With RSGA's alternative cover solutions, we have reduced costs while maintaining environmental safety standards at the Kivites landfill.",
			link: 'https://rsga.lv/docs/RSGA_ADC_eng.pdf'
		}
	],
	cta_block: {
